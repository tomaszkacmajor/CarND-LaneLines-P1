...
## Digest and discussion can be found on this [blog post](http://tomaszkacmajor.pl/index.php/2017/05/17/lane-lines-detection/).
...
Below, there are 3 examples of loaded images. Later, after each step, intermediate results will be shown for these samples images. The third one is the most demanding for processing as there are shadows and contrasts between yellow line and the road is very small.</br>
...
```
For extraction of white color I filtered only high lightness from the "L" component of HSL color space. For yellow lanes I chose Hue to be more or less at 30 to select yellow color and filtered Saturation to be quite hith. Below, there are test images after such filtering.</br></br>
...
<img src="./output_images/solidWhiteCurve_5_edgesImage.jpg" height="160">  <img src="./output_images/solidYellowCurve2_5_edgesImage.jpg" height="160">  <img src="./output_images/challengeSnap3_5_edgesImage.jpg" height="160">
